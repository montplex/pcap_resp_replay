...
public class FromKafkaConsumer extends BaseConsumer {
    ...
    public FromKafkaConsumer(String topic, String broker, String groupId) {
        this.topic = topic;
        this.broker = broker;
    ...
    public static void main(String[] args) {
        var resp = new RESP();
        var consumer = new FromKafkaConsumer("test", "localhost:9092", "test");
